              ...
              <div className="mx-auto max-w-4xl">
                ...
                <div className="flex flex-col border-b border-gray-100 p-6 text-center sm:border-0 sm:border-r">
                  ...
                  <div className="flex flex-col border-t border-gray-100 p-6 text-center sm:border-0 sm:border-l">
                    ...
                    <dd className="order-1 text-5xl font-bold tracking-tight text-indigo-600">27th Nov</dd>
                  </div>
                  ...
                  <dt className="order-2 mt-2 text-lg font-medium leading-6 text-gray-500">Fri 10am - 6pm</dt>
                    <dd className="order-1 text-5xl font-bold tracking-tight text-indigo-600">1st Nov</dd>
                  </div>
                  <div className="flex flex-col border-t border-gray-100 p-6 text-center sm:border-0 sm:border-l">
                  ...
                  <dt className="order-2 mt-2 text-lg font-medium leading-6 text-gray-500">Sun 10am - 4pm</dt>
                    <dd className="order-1 text-5xl font-bold tracking-tight text-indigo-600">3rd Nov</dd>
                  </div>
              
                
                  <div className="flex flex-col border-t border-gray-100 p-6 text-center sm:border-0 sm:border-l">
                  <dt className="order-2 mt-2 text-lg font-medium leading-6 text-gray-500">Mon 10am - 5pm</dt>
                    <dd className="order-1 text-5xl font-bold tracking-tight text-indigo-600">4th Nov</dd>
                  </div>
                  <div className="flex flex-col border-t border-gray-100 p-6 text-center sm:border-0 sm:border-l">
                   <dt className="order-2 mt-2 text-lg font-medium leading-6 text-gray-500">Tues 10am - 7pm</dt>
